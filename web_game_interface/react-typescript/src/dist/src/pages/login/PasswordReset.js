...
const PasswordReset = () => {
    ...
    return (React.createElement("div", { className: "wrapper" },
        ...
        React.createElement("article", { className: "contents" },
            React.createElement("div", { className: "area-cmn-01" },
                React.createElement("section", { className: "sec-cmn-01" },
                    React.createElement("h1", { className: "sec-cmn-in-01" }, "Password reset"),
